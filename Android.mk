...
FFMPEG_CFLAGS += -DCONFIG_USE_CALLSTACK=0
$(warning "Build1 ffmpeg-aml at : "$(PLATFORM_SDK_VERSION))
else
FFMPEG_CFLAGS += -DCONFIG_USE_CALLSTACK=1
$(warning "Build2 ffmpeg-aml at : "$(PLATFORM_SDK_VERSION))
endif
...
ifneq (0, $(shell expr $(PLATFORM_SDK_VERSION) \>= 30))
FFMPEG_LIBAVUTIL_SRC_FILES += libavutil/callstack.cpp
endif
