...
#define AV_CH_TOP_SIDE_LEFT                             36
#define AV_CHAN_TOP_SIDE_RIGHT                          37
#define AV_CHAN_BOTTOM_FRONT_CENTER                     38
#define AV_CHAN_BOTTOM_FRONT_LEFT                       39
#define AV_CHAN_BOTTOM_FRONT_RIGHT                      40

#define AV_CHAN_TOP_SIDE_LEFT        (1ULL << AV_CHAN_TOP_SIDE_LEFT        )
