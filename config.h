...
#define FFMPEG_CONFIGURATION "--arch=arm --cross-prefix=/mnt/fileroot/jian.wang/code/n-amlogic/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.9/bin/arm-linux-androideabi- --target-os=android --disable-ffplay --disable-postproc --disable-gpl --disable-static --enable-shared --disable-encoder=flac --disable-decoder='cavs,ac3_fixed,ac3,eac3,mlp,dca,amrnb' --disable-encoder='ac3,ac3_fixed,eac3,mlp,dca,truehd' --disable-demuxer='ac3,eac3,dts,dtshd,spdif,truehd' --disable-muxer='ac3,eac3,dts,dtshd,spdif' --disable-parser='dca,mlp' --disable-bsf=dca_core --disable-zlib --enable-pic --enable-cross-compile --sysroot=/mnt/fileroot/jian.wang/code/n-amlogic/prebuilts/ndk/current/platforms/android-24/arch-arm --cpu=armv7-a --extra-cflags='-march=armv7-a -mfloat-abi=softfp -mfpu=neon' --enable-armv5te --enable-armv6 --enable-armv6t2 --enable-neon --disable-programs --disable-inline-asm"
